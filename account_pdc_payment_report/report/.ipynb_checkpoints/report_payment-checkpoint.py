...
class ReportPayment(models.AbstractModel):
    ...
    def get_lines(self, payment_type, journal_id, pdc_only, data):
        ...
        if pdc_only:
            ...
            if data['form']['planed_date_from']:
                domain.append(('planned_date', '>=', data['form']['planed_date_from']))
            if data['form']['planed_date_to']:
                domain.append(('planned_date', '>=', data['form']['planed_date_to']))
                   
            if data['form']['date_encashed_from']:
                domain.append(('encashed_date', '>=', data['form']['date_encashed_from']))
            if data['form']['date_encashed_to']:
                domain.append(('encashed_date', '>=', data['form']['date_encashed_to']))
