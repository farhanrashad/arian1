...
class account_payment(models.Model):
    ...
    def _prepare_payment_return_moves(self):
    ...
    def _prepare_payment_deposit_moves(self):
        ...
        for payment in self:
            ...
            if payment.payment_type in ('outbound', 'transfer'):
                counterpart_amount = payment.amount               
                liquidity_line_account = payment.journal_id.default_credit_account_id
                debit_liquidity_line_account = payment.pdc_account_id
            else:
                counterpart_amount = -payment.amount
                liquidity_line_account = payment.journal_id.default_credit_account_id
            ...
            move_vals = {
                ...
                'line_ids': [
                    ...
                    (0, 0, {
                        ...
                        'date_maturity': payment.payment_date,
                        'partner_id': payment.partner_id.commercial_partner_id.id,
                        'account_id': payment.pdc_account_id.id,
                        'payment_id': payment.id,
                    }),
                    # Liquidity line.
                    (0, 0, {
...
#                 raise UserError(_("Only a draft payment can be posted."))
            ...
            moves = AccountMove.create(rec._prepare_payment_return_moves())
...
#                 raise UserError(_("Only a draft payment can be posted."))
            ...
            moves = AccountMove.create(rec._prepare_payment_deposit_moves())
            moves.filtered(lambda move: move.journal_id.post_at != 'bank_rec').post()
