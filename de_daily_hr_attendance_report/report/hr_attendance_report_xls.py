...
class HrAttendanceXlsx(models.AbstractModel):
    ...
    def _get_hr_attendance_data(self, data):
        ...
        for employee in employees:
            ...
            hr_attendance = self.env['hr.attendance'].search([('attendance_date', '=', data['on_date']), ('employee_id','=', employee.id)], order="check_in desc")
    ...
    def generate_xlsx_report(self, workbook, data, products):
        ...
        headers = ['Department', 'Check In', 'Check Out', 'Shift', 'Work Hours']
...
#             })
        for val in data_list:
            ...
            sheet.write(row, col + 4, val['check_in'], format6)
            sheet.write(row, col + 5, val['check_out'], format6)
